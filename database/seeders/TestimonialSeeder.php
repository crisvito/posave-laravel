...
class TestimonialSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Testimonial::create([
            ...
            'message_en' => 'POSAVE has made our business operations more efficient. Monitoring transactions, stock, and reports can now be done quickly in a single dashboard.',
        ]);
        ...
        Testimonial::create([
            ...
            'message_en' => 'POSAVE helps us manage business operations more efficiently. Monitoring transactions and reports is now faster and more practical.',
        ]);
    }
}
