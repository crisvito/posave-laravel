...
// 1. Tambahkan import komponen animasi yang sudah kamu buat
...
export default function Inquiry() {
    ...
    // 2. Panggil fungsi smooth scroll di dalam komponen
    useSmoothScroll();
    ...
    return (
        <AppLayout>
            ...
            <div className="flex flex-col gap-8 py-8">
                {/* 3. Bungkus Hero Banner dengan Reveal */}
                <Reveal>
                ...
                {/* 4. Bungkus FAQ Banner dengan Reveal (beri sedikit delay) */}
                <Reveal delay={0.1}>
                ...
                <div className="mt-4 grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-8">
                    {/* 5. Bungkus Info Kontak sebelah kiri dengan Reveal */}
                    <Reveal delay={0.2}>
                    ...
                    {/* 6. Bungkus Form Kontak sebelah kanan dengan Reveal */}
                    <Reveal delay={0.4}>
                        <div>
                            <ContactForm />
                        </div>
                ...
                {/* 7. Bungkus Help Banner paling bawah dengan Reveal */}
                <Reveal delay={0.1}>
                    <div className="mt-8 flex flex-col items-center justify-between rounded-2xl border border-[var(--border-strong)] bg-[var(--card)] p-8 md:flex-row md:px-12">
                        ...
                        <a href="https://wa.me/628112345567" target="_blank" rel="noopener noreferrer" className="mt-6 w-full md:mt-0 md:w-auto">
                            <Button className="h-12 w-full rounded-full bg-[var(--secondary-600)] px-8 text-white hover:bg-[var(--secondary-700)]">
