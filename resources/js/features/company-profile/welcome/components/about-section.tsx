                ...
                <div className="mx-auto max-w-6xl">
                    <div className="grid items-center gap-12 px-8 py-14 md:px-16 md:py-16 lg:grid-cols-[1.2fr_0.9fr]">
                        <div className="min-w-0 flex-1">
                            ...
                            >
                                Atur Usaha <br />
                                <span className="font-semibold">Ga Pake Ribet</span>
                            </h2>

                            <p className="mb-10 max-w-xl text-[16px] leading-9 text-[var(--muted-foreground)]">
                                Posave memiliki misi untuk memudahkan Anda dalam mengatur usaha dengan perangkat yang Anda miliki tanpa perlu
                                training.
                            </p>
