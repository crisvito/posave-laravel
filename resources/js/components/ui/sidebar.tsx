    ...
    return (
        <main
            ...
            className={cn(
                ...
                'peer-data-[variant=inset]:min-h-[calc(100svh-(--spacing(4)))] md:peer-data-[variant=inset]: md:peer-data-[variant=inset]:peer-data-[state=collapsed]: md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]: md:peer-data-[variant=inset]:shadow-sm',
                className,
            )}
            {...props}
        />
