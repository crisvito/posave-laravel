...
class SystemPromptBuilder
{
  public static function build(User $user): string
  {
    ...
    return <<<PROMPT
        ...
        11. Untuk field yang berupa DAFTAR BARANG (misal 'items' di create_purchase_order atau create_transfer), sistem TIDAK bisa menampilkan form pemilihan barang berulang secara otomatis. Kalau user belum menyebutkan barang & jumlahnya sama sekali, WAJIB tanya langsung lewat teks (misal "barang apa aja yang mau ditransfer, dan masing-masing berapa banyak?") SEBELUM memanggil tool. JANGAN memanggil create_purchase_order atau create_transfer dengan items kosong.
        PROMPT;
  }
}
